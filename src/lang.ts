...
const strings: { [key: string]: { [key: string]: string } } = {
    "en": {
        ...
        "DeleteCurrentProfileWarnning": "This is the active profile. Deleting it will switch to the default profile. Continue?",
        "Cancel": "Cancel",
        "Delete": "Delete",
        "Backup": "Backup",
    ...
    "he": {
        ...
        "DeleteCurrentProfileWarnning": "זהו הפרופיל הנוכחי. מחיקתו תשנה לפרופיל הבית. להמשיך?",
    ...
    "ar": {
        ...
        "DeleteCurrentProfileWarnning": "هذا هو الملف الشخصي النشط. حذفه سيؤدي إلى التبديل إلى الملف الشخصي الافتراضي. هل ترغب في المتابعة؟",
